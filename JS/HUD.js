...
game.HUD.Container = me.Container.extend({
    ...
    init: function() {
        ...
        this.addChild(new game.HUD.AnotherScoreItem(-80,-10));
...
/**
     * ONE MORE SCORING ITEM TO COUNT THE NUMBER OF COLLISIONS WHICH CAN BE USED TO COUNT PROTEIN BARS OR BURGERS IN OUR GAME.(23 OCT)
     */
game.HUD.AnotherScoreItem = me.Renderable.extend({
    /**
     * constructor
     */
    init: function(x, y) {
